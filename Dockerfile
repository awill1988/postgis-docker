...
ENV PG_MAJOR 13
ENV PG_VERSION 13~rc1-1.pgdg110+1
...
# TODO remove this once we hit bullseye+
					echo 'deb http://deb.debian.org/debian bullseye-backports main' >> /etc/apt/sources.list.d/pgdg.list; \
					;; \
			esac; \
			\
			tempDir="$(mktemp -d)"; \
...
ENV POSTGIS_MAJOR 3
ENV POSTGIS_VERSION 3.0.2+dfsg-2.pgdg110+1
